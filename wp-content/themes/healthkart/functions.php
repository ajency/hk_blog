...
function my_child_theme_scripts() {
    wp_enqueue_style( 'parent-theme-css', get_stylesheet_directory_uri() . '/style.css' );
 	wp_enqueue_style('theme-styles', get_stylesheet_directory_uri() . '/assets/css/theme-styles.css', array(), '4.3', false);
    ...
    wp_enqueue_style('font-family-nunito', 'https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,400;0,600;0,700;1,600&display=swap', array(), '', false);
	wp_enqueue_style('font-family-birthstone', 'https://fonts.googleapis.com/css2?family=Birthstone&display=swap', array(), '', false);
