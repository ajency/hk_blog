...
<button type="button" class="btn m-0 mt-2 mr-3 py-2 px-3 category-buttons-single slick-slide slick-current slick-active" data-val="22" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide20">Bodybuilding</button>
		</div>
	</div>
