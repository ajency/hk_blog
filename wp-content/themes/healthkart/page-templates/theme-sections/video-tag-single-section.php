...
<div class="container category-container">
	...
	<div class="latest-reads category-list-view position-relative mt-4" data-category="<?php echo $category->term_id; ?>" data-type="video" data-count="<?php echo $wp_query->found_posts; ?>" data-taxonomy="<?php echo $category->taxonomy; ?>">
