<div class="transformation-section-single col-md-4 col-12 my-4">
    ...
    <div class="transformation-section-single-content">
        <div class="content-title">
            <span>
                <span class="category">
                    <a target="_blank" title="Transformation"
                        href="<?php echo get_post_type_archive_link(get_post_type()); ?>"
                        rel="category tag">Transformation</a>
                </span>
            ...
            <h2 class="title"><a title="<?php the_title(); ?>"
        ...
        <div class="content-fields p-3">
            ...
            <div class="content-fields-values row">
                <span
                    class="content-fields-values-single col-md-2 pr-2"><?php echo $before_age.'/'.$after_age; ?></span>
                <span
                    class="content-fields-values-single transformation-before col-md-2 px-2"><?php echo $before_weight; ?>kg</span>
                <span class="content-fields-values-single transformation-seperator col-md-1 px-2">></span>
                <span
                    class="content-fields-values-single transformation-after transformation-border-right col-md-2 px-2"><?php echo $after_weight; ?>kg</span>
                <span
                    class="content-fields-values-single transformation-before col-md-2 px-2"><?php echo is_numeric($before_fat) ? $before_fat.'%' : $before_fat; ?></span>
                <span class="content-fields-values-single transformation-seperator col-md-1 px-2">></span>
                <span
                    class="content-fields-values-single transformation-after col-md-2 px-2"><?php echo is_numeric($after_fat) ? $after_fat.'%' : $after_fat; ?></span>
            </div>
        </div>
    </div>
</div>